...
For the contour lines, I searched “how to add contour lines to a ggplot” and found the relevant documentation (https://ggplot2.tidyverse.org/reference/geom_density_2d.html). After a qucik review, I did not find any issues.
